...
export default function Discover() {
  ...
  if (filterParams.mediaType === "movie") {
    ...
    filterQuery = `sort_by=${filterParams.sortBy}&vote_average.lte=${filterParams.voteAverage}&include_adult=false&year=&primary_release_year=${filterParams.year}&with_genres=`;
  }
